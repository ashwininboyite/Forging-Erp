...
<html class="fixed">
	<head>
		...
		<title>Cutting Pending New </title>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Cutting</span></li>
								<li><span><a href="cutting_pending.jsp">Cutting</a></span></li>
								<li><span><a href="cutting_pending_new.jsp">Cutting Pending New </a></span></li>
							</ol>
    				...
    				<header class="panel-heading" style="margin-top:3%">
										...
										<h5 class="panel-title">Cutting Pending New</h5>
								</header>
