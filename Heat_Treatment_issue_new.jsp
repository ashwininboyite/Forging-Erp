...
<html class="fixed">
	<head>
		...
		<title>Heat Treatment Issue New </title>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Heat Treatment Issue New </h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Heat Treatment</span>
								<li><span><a href="Heat_Treatment_issue.jsp">Heat Treatment</a></span>
								<li><span><a href="Heat_Treatment_issue_new.jsp">Heat Treatment Issue New </a></span>
							</ol>
    				...
    				<header class="panel-heading" style="margin-top:3%">
										...
										<h5 class="panel-title">Heat Treatment Issue New</h5>
								</header>
