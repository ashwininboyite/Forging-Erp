...
<html class="fixed">
	<head>
		...
		<title>Machining Issue new</title>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Machining</span>
								<li><span><a href="Machining_issue.jsp">Machining Issue</a></span>
								<li><span><a href="Machining_issue_new.jsp">Machining Issue new</a></span>
							</ol>
    				...
    				<header class="panel-heading" style="margin-top:3%">
										...
										<h5 class="panel-title">Machining Issue New</h5>
								</header>
