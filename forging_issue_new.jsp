			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Forging</span></li>
								<li><span><a href="forging_issue.jsp">Forging Issue</a></span></li>
								<li><span><a href="forging_issue_new.jsp">Forging Issue New </a></span></li>
							</ol>
    				...
    				<header class="panel-heading" style="margin-top:3%">
										...
										<h5 class="panel-title">Forging Issue New</h5>
								</header>
