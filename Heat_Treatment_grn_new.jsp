...
<html class="fixed">
	<head>
		...
		<title>Heat Treatment GRN New </title>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span><a href="Heat_Treatment_grn.jsp">Heat Treatment GRN</a></span>
								<li><span><a href="Heat_Treatment_grn_new.jsp">Heat Treatment GRN New </a></span>
							</ol>
    				...
    				<header class="panel-heading" style="margin-top:3%">
										...
										<h5 class="panel-title">Heat Treatment GRN New</h5>
								</header>
