			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span><a href="Machining_grn.jsp">Machining GRN</a></span>
								<li><span><a href="Machining_grn_new.jsp">Machining GRN new</a></span>
							</ol>
    				...
    				<header class="panel-heading" style="margin-top:3%">
										...
										<h5 class="panel-title">Machining GRN new</h5>
								</header>
