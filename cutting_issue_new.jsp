			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span><a href="cutting_issue.jsp">Cutting Issue</a></span>
								</li>
								<li><span><a href="cutting_issue_new.jsp">Cutting Issue new </a></span>
								</li>
							</ol>
    				...
    				<header class="panel-heading" style="margin-top:3%">
										...
										<h5 class="panel-title">Cutting Issue New</h5>
								</header>
